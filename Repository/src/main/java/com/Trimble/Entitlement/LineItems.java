...
public class LineItems {
	...
	String lineItemId;
	com.Trimble.Entitlement.StartDate startDate;
	EndDate endDate;
	int totalQuantity;
	...
	public com.Trimble.Entitlement.StartDate getStartDate() {
		return startDate;
	}

	public void setStartDateLineItem(com.Trimble.Entitlement.StartDate startDate) {
