...
public class Activation {
	...
	String activatorId;
	boolean isActive;
	com.Trimble.Activations.ActivationDate activationDate;
	com.Trimble.Activations.ExpiryDate expiryDate;
	String currentState;
	...
	public com.Trimble.Activations.ActivationDate getActivationDate() {
		return activationDate;
	}

	public void setActivationDate(com.Trimble.Activations.ActivationDate activationDate) {
		this.activationDate = activationDate;
	}

	public com.Trimble.Activations.ExpiryDate getExpiryDate() {
		return expiryDate;
	}

	public void setExpiryDate(com.Trimble.Activations.ExpiryDate expiryDate) {
